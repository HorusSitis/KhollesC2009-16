...
%\usepackage{amsthm}
\usepackage{framed}
%%% ----------- attention à la numérotation des équations, pas de thmmarks ! ----------- %%%
\usepackage[amsthm,%
%thmmarks,%
framed]
{ntheorem}
%% ----------- éventuellements remplacer par ... ----------- %%
%\usepackage{amsthm}
...
\newframedtheorem{exer}{Exercice}[section]
}
...
\theoremstyle{break}
%\theoremprework{\vspace{0.2cm}}
\theorempostwork{\etoile}%\hfill\rule{0.6\linewidth}{0.4pt}\hfill\null}

\theoremheaderfont{\scshape}
\theorembodyfont{\normalfont}
\theoremseparator{ :\newline\vspace{0.2cm}}
\newtheorem{rep}{R\'eponse}[ques] %Autre pr\'esentation : encadrer les \'enonc\'es ?
}
...
\newenvironment{remer}{\setlength{\parskip}{0.35cm}\em}{\vspace{1cm}\setlength{\parskip}{0.0cm}}

\renewcommand{\theequation}{\thechapter \hspace{-0.1cm} $\cdot$ \hspace{-0.1cm}\arabic{equation}}%%\hspace*{0.05pt}
